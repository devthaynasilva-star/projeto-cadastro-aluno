...
## Sobre o Projeto
Este **Sistema de Cadastro de Alunos** é uma aplicação FullStack desenvolvida como um projeto de revisão de conteúdo no curso de Desenvolvimento de Sistemas, oferecido pelo SENAI Sorocaba - Gaspar Ricardo Junior, ministrado pelo Prof. [Vedilson Prado](https://github.com/vedilsonprado). O objetivo do projeto é consolidar conhecimentos em criação de API RestFull, manipulação de 
Banco de Dados Relacional e integração com o Frontend usando JavaScript.

A aplicação permite o gerenciamento completo (CRUD) de alunos, incluindo validações de regras de negócio e persistencia de dados.
...
### Frontend
- **HTML5 & CSS3:** Estrutura semantica e estilização
...
[Thayná Visentin](@thayna.visentin)
